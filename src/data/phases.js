...
export const PHASE_ICONS = {
  command: { label: 'Command', svg: `<svg viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><circle cx="12" cy="12" r="3.5"/><line x1="12" y1="2" x2="12" y2="5.5" stroke="currentColor" strokeWidth="2" strokeLinecap="round"/><line x1="12" y1="18.5" x2="12" y2="22" stroke="currentColor" strokeWidth="2" strokeLinecap="round"/><line x1="2" y1="12" x2="5.5" y2="12" stroke="currentColor" strokeWidth="2" strokeLinecap="round"/><line x1="18.5" y1="12" x2="22" y2="12" stroke="currentColor" strokeWidth="2" strokeLinecap="round"/><line x1="4.93" y1="4.93" x2="7.34" y2="7.34" stroke="currentColor" strokeWidth="2" strokeLinecap="round"/><line x1="16.66" y1="16.66" x2="19.07" y2="19.07" stroke="currentColor" strokeWidth="2" strokeLinecap="round"/><line x1="19.07" y1="4.93" x2="16.66" y2="7.34" stroke="currentColor" strokeWidth="2" strokeLinecap="round"/><line x1="7.34" y1="16.66" x2="4.93" y2="19.07" stroke="currentColor" strokeWidth="2" strokeLinecap="round"/></svg>` },
  movement: { label: 'Movement', svg: `<svg viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><polygon points="12,3 20,13 15,13 15,18 9,18 9,13 4,13"/><rect x="5" y="20" width="14" height="2.5" rx="1"/></svg>` },
  shooting: { label: 'Shooting', svg: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" xmlns="http://www.w3.org/2000/svg"><circle cx="12" cy="12" r="5.5"/><line x1="12" y1="2" x2="12" y2="6"/><line x1="12" y1="18" x2="12" y2="22"/><line x1="2" y1="12" x2="6" y2="12"/><line x1="18" y1="12" x2="22" y2="12"/><line x1="12" y1="10.5" x2="12" y2="13.5" strokeWidth="2.5"/><line x1="10.5" y1="12" x2="13.5" y2="12" strokeWidth="2.5"/></svg>` },
  charge: { label: 'Charge', svg: `<svg viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><polygon points="12,3 22,10 18.5,10 12,5.5 5.5,10 2,10"/><polygon points="12,11 22,18 18.5,18 12,13.5 5.5,18 2,18"/></svg>` },
  fight: { label: 'Fight', svg: `<svg viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><rect x="10.3" y="2" width="4.5" height="7" rx="1" transform="rotate(45 12 12) translate(-1.5 -8.5)"/><rect x="2" y="2.5" width="2" height="12" rx="1" transform="rotate(45 4 8)"/><rect x="13.3" y="2" width="4.5" height="7" rx="1" transform="rotate(-45 12 12) translate(1.5 -8.5)"/><rect x="20" y="2.5" width="2" height="12" rx="1" transform="rotate(-45 20 8)"/></svg>` },
  end: { label: 'End', svg: `<svg viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path d="M6 2h12v2c0 3-2.5 5-6 6-3.5-1-6-3-6-6V2z"/><path d="M6 22h12v-2c0-3-2.5-5-6-6-3.5 1-6 3-6 6v2z"/><rect x="5" y="3.5" width="14" height="1.2" rx="0.5"/><rect x="5" y="19.3" width="14" height="1.2" rx="0.5"/></svg>` },
};
